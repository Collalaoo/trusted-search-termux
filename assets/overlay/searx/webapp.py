...
# When launched via ``python searx/webapp.py`` or ``python -m searx.webapp``,
# this module runs under the name "__main__".  Later ``from searx import
# webapp`` (e.g. in google_autocomplete_icons) would otherwise import it a
# second time and re-run ``init()`` (duplicate plugins / name collisions).
if __name__ == "__main__":
    import sys

    sys.modules.setdefault("searx.webapp", sys.modules[__name__])
